  ...
  return (
    <div className="md:w-1/2 lg:w-2/5 mx-5">
      <div >
          ...
          <p className="text-xl mt-5 text-center mb-10 font-medium">
            Añade Pacientes y {''}
      ...
      >
        ...
        <input 
          ...
          className="bg-indigo-600 w-full p-3 text-white uppercase font-boldA cursor-pointer hover:bg-indigo-700 transition-all"
        />
      </form>
    </div>
  )
